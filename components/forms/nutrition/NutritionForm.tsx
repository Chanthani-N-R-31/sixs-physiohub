  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <div className="bg-gray-100 rounded-xl shadow-md p-6 border border-gray-400">
        <h3 className="text-3xl font-bold text-white text-center mb-4">Session Context</h3>
          ...
          <table className="w-full text-sm">
            <thead className="text-xs uppercase text-black border-b border-gray-400">
              <tr>
                ...
                <th className="py-3 text-left font-bold">Unit / Guidance</th>
              ...
              {PARAMETER_CONFIG.map((param) => (
                <tr key={param.id}>
                  ...
                  <td className="py-4">
                    <input
                      type="text"
                      className="w-full rounded-lg border border-gray-400 px-3 py-2 text-sm text-black placeholder-gray-500 bg-white focus:border-blue-500 focus:ring-blue-500"
