...
export default function StrengthStability({ initialData, onSave }: StrengthStabilityProps) {
  ...
  return (
    <div className="space-y-10">
      <h3 className="text-3xl font-bold text-white text-center">Strength & Stability</h3>

      {/* ===================== CORE SECTION ====================== */}
      <section className="bg-gray-100 p-4 rounded-xl border border-gray-400 shadow-lg">
        <h4 className="text-lg font-bold text-black mb-3">Core Stability</h4>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="text-sm font-bold text-black">Plank Hold Time (seconds)</label>
            <div>
              <input
                type="number"
                min="0"
                ...
                className={`w-full mt-1 p-2 bg-white border border-gray-400 text-black rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
          ...
          <div>
            <label className="text-sm font-bold text-black">Side Plank - Left (seconds)</label>
            <div>
              <input
                type="number"
                min="0"
          ...
          <div>
            <label className="text-sm font-bold text-black">Side Plank - Right (seconds)</label>
            <div>
              <input
                type="number"
                min="0"
        ...
        <div className="mt-4">
          ...
          <div>
            <textarea
              ...
              className={`w-full p-3 mt-1 bg-white border border-gray-400 text-black rounded focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-vertical ${
      ...
      {/* ===================== BALANCE SECTION ====================== */}
      <section className="bg-gray-100 p-4 rounded-xl border border-gray-400 shadow-lg">
        <h4 className="text-lg font-bold text-black mb-3">Balance</h4>
        <div className="space-y-4">
          <div>
            <label className="text-sm font-bold text-black">Static Balance</label>
            <input
              type="text"
          ...
          <div>
            <label className="text-sm font-bold text-black">Dynamic Balance</label>
            <input
              type="text"
